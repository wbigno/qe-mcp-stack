...
- Complete Swagger UI with all 10 MCPs
...
1. **Integration MCPs (8100-8199)**
   ...
   - Test Plan Manager: Test planning

2. **Code Analysis MCPs (8200-8299)**
   - Code Analyzer: Static code analysis
   - Coverage Analyzer: Test coverage
   - Playwright Generator: Test generation
   - Migration Analyzer: Migration tracking

3. **Quality Analysis MCPs (8300-8399)**
   - Risk Analyzer: AI-powered risk assessment
   - Integration Mapper: Dependency mapping
