...
echo "  - ADO Dashboard UI:            http://localhost:5173"
echo "  - Code Dashboard UI:           http://localhost:8081"
echo "  - Swagger Hub:                 http://localhost:8000"
echo ""
...
echo "  - .NET Code Analyzer:          http://localhost:8200"
echo "  - .NET Coverage Analyzer:      http://localhost:8201"
echo "  - Migration Analyzer:          http://localhost:8203"
echo "  - JavaScript Code Analyzer:    http://localhost:8204"
echo "  - JavaScript Coverage Analyzer: http://localhost:8205"
echo ""
...
echo "  - Playwright Generator:        http://localhost:8400"
echo "  - Playwright Analyzer:         http://localhost:8401"
echo "  - Playwright Healer:           http://localhost:8402"
echo ""
