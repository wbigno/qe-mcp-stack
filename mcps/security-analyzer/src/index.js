...
function performAnalysis(files, config) {
  // OWASP checks, HIPAA compliance, vulnerability scan
  ...
  // Implement specific logic for security-analyzer
  for (const file of files) {
...
app.listen(PORT, () => {
  console.log(`security-analyzer MCP running on port ${PORT}`);
  console.log('Endpoints:');
  console.log('  POST /analyze-security');
