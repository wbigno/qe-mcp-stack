 ...
 * 
 * Generates integration tests for .NET APIs and services.
 * Uses Anthropic Claude API for intelligent test generation.
 * 
 * Communication: JSON via stdin/stdout
 */

import { generateIntegrationTests } from './src/generator.js';
...
process.stdin.on('end', async () => {
  try {
    ...
    if (!apiEndpoint) {
      throw new Error('Missing required field: apiEndpoint');
    }
