...
function performAnalysis(files, config) {
  // Scan for HttpClient, API calls, external references
  ...
  // Implement specific logic for integration-mapper
  for (const file of files) {
